...
<head>
    ...
    <link href="assets/css/iziToast.min.css" rel="stylesheet" async>
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 info-column">
                        <div class="single-info-box">
                            <div class="inner-box">
                                <div class="icon-box"><i class="flaticon-email"></i></div>
                                <p><a href="mailto:sunil@aceglobalhr.com">sunil@aceglobalhr.com</a><br /><a
                                        href="mailto:hr@aceglobalhr.com">hr@aceglobalhr.com</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 info-column">
                        <div class="single-info-box">
                            <div class="inner-box">
                                <div class="icon-box"><i class="flaticon-telephone"></i></div>
                                <p><a href="tel:9538969696">9538969696</a><br /><a href="tel:9980530284">9980530284</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 info-column">
                        <div class="single-info-box">
                            <div class="inner-box">
                                ...
                                <p>Address: 16, 2nd Floor, Evergreen House Kanakanapalya, Road, Basavanagudi, Bengaluru,
                                    Karnataka 560004</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-12 col-sm-12 title-column">
                        <div class="title-inner">
                            ...
                            <div class="text">
                                <p>Contact Ace Global HR now for a structured and customised discussion about your
                                    business plans, challenges or initiatives. Find out how we can provide you with the
                                    systematic business support and prowess you need.</p>
                            </div>
