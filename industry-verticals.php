...
<body>
    ...
    <div class="boxed_wrapper">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                            <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms"
                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="blog-details.html">Automobile & Auto Components Industry</a></h3>
                                        <p>At Ace Global HR, we understand the industry’s requirements and our robust
                                            team works very closely to identify the right talent in the areas such as R
                                            and D, manufacturing, construction, operations, IT, corporate management,
                                            HR, production, body shop, maintenance, sales and marketing, finance,
                                            customer care, design, etc.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                            <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms"
                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="blog-details.html">Development</a></h3>
                                        <p>We are a self-motivated company that believes in putting together basic
                                            amenities like clean drinking water, roads, and medical support and creating
                                            an infrastructure that will uplift the lower strata of society. Ace Global
                                            HR teams up with talented professionals from various backgrounds to raise
                                            funds for the development of the social sector.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                            <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms"
                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="blog-details.html">Education Sector</a></h3>
                                        <p>In our company, human resources play a foremost role. With the growing no of
                                            schools and colleges, we definitely need fresh talent and innovative
                                            leadership strategies that can sustain and bring a paradigm shift in the
                                            environment. Our consultants have an in-depth understanding and know-how of
                                            the entire Education domain.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                            <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms"
                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="blog-details.html">Electrical & Electronics Industry</a></h3>
                                        <p>There is a pool of highly qualified and skilled electrical and electronic
                                            engineers and our database proves just that. We not only help clients with
                                            the recruitment of top and middle management candidates but also with the
                                            enhancement of talent and people management practices. Ace Global HR meets
                                            the sector requirements pan India and the UAE region.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                            <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms"
                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="blog-details.html">Financial Services</a></h3>
                                        <p>Ace Global HR, does not just recruit for different organisations, we also
                                            undertake the role of consultants and financial advisors to our clients.
                                            With our expertise and proactive approach, we help clients address critical
                                            talent issues, guide them on succession planning and give doable advice that
                                            can help in the potential growth of your company. We open new avenues that
                                            boost financial growth.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                            <div class="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms"
                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <h3><a href="blog-details.html">Aerospace & Defense</a></h3>
                                        <p>Our approach is a combination of a profound understanding of industry
                                            dynamics with cutting-edge analytics and an exceptional network of experts.
                                            We work closely with clients to build an internal team, adopt digital and
                                            analytics tools, and enhance their business in a significant way.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- cta-style-two -->
        <section class="cta-style-two centred" style="background-image: url(assets/images/background/cta-1.jpg);">
            <div class="auto-container">
                <div class="inner-box">
                    <div class="text">
                        <div class="shape">
